...
# Created by write_sdc on Mon Jul 18 15:05:43 2022
...
set_max_dynamic_power 3.9802 mW
create_clock [get_ports Clock]  -period 3.18  -waveform {0 1.59}
set_max_delay 3.18  -from [list [get_ports Clock] [get_ports ResetN] [get_ports {Instr_In[31]}]   \
